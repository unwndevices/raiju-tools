...
class MyPanel2(wx.Panel): 
    ...
    def _init_ui(self):
        ...
        connectButton.Bind(wx.EVT_BUTTON, on_clicked)
...
class NodeMcuFlasher(wx.Frame):
    ...
    def _build_menu_bar(self):
        ...
        exit_item = file_menu.Append(wx.ID_EXIT, "E&xit\tCtrl-Q", "Exit Raiju-tools")
        self.Bind(wx.EVT_MENU, self._on_exit_app, exit_item)
        self.menuBar.Append(file_menu, "&File")

        # Help menu
        help_menu = wx.Menu()
        help_item = help_menu.Append(wx.ID_ABOUT, '&About Raiju-tools', 'About')
...
class MySplashScreen(wx.adv.SplashScreen):
    def __init__(self):
        wx.adv.SplashScreen.__init__(self, images.Splash.GetBitmap(),
                                     wx.adv.SPLASH_CENTRE_ON_SCREEN | wx.adv.SPLASH_TIMEOUT, 250, None, -1)
        self.Bind(wx.EVT_CLOSE, self._on_close)
        self.__fc = wx.CallLater(250, self._show_main)
